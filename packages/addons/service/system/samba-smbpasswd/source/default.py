...
__scriptname__ = "Alternative server for XBMC"
__author__     = "OpenELEC"
__url__        = "http://www.openelec.tv"
__settings__   = xbmcaddon.Addon(id='service.system.samba')
__cwd__        = __settings__.getAddonInfo('path')
__path__       = xbmc.translatePath( os.path.join( __cwd__, 'bin', "samba.service") )
__username__   = __settings__.getSetting('USERNAME')
__password__   = __settings__.getSetting('PASSWORD')

os.system( "chmod a+rx " + __path__ )
os.system( "%s '%s' '%s' "%(__path__,__username__,__password__.replace("'", "'\\''")) )
